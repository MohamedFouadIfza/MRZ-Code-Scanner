        ...
        messages: [
            {
                ...
                content: [
                    {
                        type: 'text',
                        text: "act as passport reader, extract in English fullName,firstName,lastName,sex,documentNumber,expirationDate and birthDate as format 16,01,2025,place_of_Issue,country_of_Issue,nationalty as country from this passport as JSON only"
                    },
                    {
                        type: "image_url",
                        image_url: {
